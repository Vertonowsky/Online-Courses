...
import com.example.vertonowsky.security.handler.MyAuthenticationFailureHandler;
import com.example.vertonowsky.security.handler.MyAuthenticationSuccessHandler;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/api/user/courses").permitAll()
                .antMatchers("/list-used-discount-code").permitAll()
                .antMatchers("/wyswietl/**").permitAll()
                .antMatchers("/kurs/getCourses").permitAll()
                .antMatchers("/api/courses/list").permitAll()
                .antMatchers("/api/courses/top-panel").permitAll()
